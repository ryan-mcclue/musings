...
Now in another loop, we iterate over the WorkOrders and run the previous `render_chunk` function with the WorkOrders values.
Also pass into this `render_chunk` function the WorkQueue that will store accumulator values
